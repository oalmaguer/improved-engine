        ...
        <div className="relative group">
            ...
            >
                {images.map((image) => (
                    <div
                        key={image.id}
                        className="flex-none w-[400px] h-[400px] relative group snap-start rounded-2xl overflow-hidden"
                    >
                        <ImageLightbox
                            src={image.image_url}
                            alt={image.prompt}
                        ...
                        {/* Hover Overlay */}
                        <div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-75 transition-all duration-200">
                            <div className="absolute inset-0 p-6 text-white opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex flex-col justify-between">
