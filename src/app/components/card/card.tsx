...
export default function Card({ image, variant = "grid" }: CardProps) {
  ...
  return (
    ...
    >
      ...
      {/* Overlay */}
      <div className="absolute inset-0 bg-black opacity-0 group-hover/card:opacity-75 transition-opacity duration-200" />

      {/* Content */}
      <div className="absolute inset-0 p-4 text-white opacity-0 group-hover/card:opacity-100 transition-opacity duration-200 flex flex-col justify-between">
